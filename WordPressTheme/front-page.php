      ...
      <aside class="p-top-mv__nav">
        ...
        <div class="p-top-mv__icons">
          <div class="p-top-mv__icon">
            <a href="">
              <img src="<?php echo get_template_directory_uri(  ) ?>/assets/img/top/icon_twitter-dark.svg" alt="twitterアイコン">
            </a>
          </div><!-- /.p-top-mv__icon -->
          <div class="p-top-mv__icon">
            <a href="">
              <img src="<?php echo get_template_directory_uri(  ) ?>/assets/img/top/icon_instagram-dark.svg" alt="instagramアイコン">
            </a>
          </div><!-- /.p-top-mv__icon -->
          <div class="p-top-mv__icon">
            <a href="">
              <img src="<?php echo get_template_directory_uri(  ) ?>/assets/img/top/icon_youtube-dark.svg" alt="youtubeアイコン">
            </a>
          </div><!-- /.p-top-mv__icon -->
       </div><!-- /.p-top-mv__icons -->
      </aside>
